...
test('§6 shop.html pages.css link uses the new shipping-inline cache key', () => {
    assert.match(
        SHOP_HTML,
        /pages\.css\?v=shipping-inline-may2026/,
        'shop.html must cache-bust pages.css with v=shipping-inline-may2026 so deployed clients pull the new rules'
    );
});
