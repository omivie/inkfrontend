...
## `outbox/` — written, no reply on record (2 files on disk; 42 deleted 2026-09-21)
...
### ⏳ Never delivered — written after the last incoming doc (13)
